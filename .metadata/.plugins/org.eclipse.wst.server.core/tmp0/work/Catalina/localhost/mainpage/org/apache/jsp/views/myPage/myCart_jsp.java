 ...
 * Generated at: 2022-07-27 05:27:10 UTC
...
public final class myCart_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 session.removeAttribute("alertMsg"); 
      ...
      out.write("		<hr>\r\n");
      out.write("       \r\n");
      out.write("		<table border=\"1\" class=\"list-area\" align=\"center\">\r\n");
      out.write("			<thead>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th><input type=\"checkbox\" checked=\"checked\" id=\"chkBoxAll\">전체선택</th>\r\n");
      out.write("					<th colspan=\"2\">상품정보</th>\r\n");
      out.write("					<th>판매가</th>\r\n");
      out.write("					<th style=\"text-align: center;\">수량</th>\r\n");
      out.write("					<th style=\"text-align: center;\">합계</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</thead>\r\n");
      out.write("			<tbody>\r\n");
      out.write("				\r\n");
 ...
 int price = p.getPrice() * p.getStock(); 
      ...
      out.write("\r\n");
      out.write("					<tr>\r\n");
      out.write("						<td class=\"cartList\"><input type=\"checkbox\" checked=\"checked\" class=\"chkBox\">선택</td>\r\n");
      out.write("						<td><img src=\"");
      out.print( p.getFilePathName());
      ...
      out.write("						<td>\r\n");
      out.write("							<span>\r\n");
      out.write("								<button type=\"button\" class=\"minusBtn\">-</button>\r\n");
      out.write("								<input type=\"text\" style=\"width:20px; text-align: center;\"  value=\"");
      out.print( p.getStock());
      out.write("\">\r\n");
      out.write("								<button type=\"button\" class=\"plusBtn\">+</button>\r\n");
      out.write("							</span>\r\n");
      out.write("						</td>\r\n");
      ...
      out.write("		</table>\r\n");
      out.write("\r\n");
      out.write("		<table border=\"1\" class=\"list-area-foot\" align=\"center\">\r\n");
      out.write("			<thead>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>총 상품금액</th>\r\n");
      out.write("					<th class=\"totalPrice1\">");
      out.print( totalPrice );
      out.write("</th>\r\n");
      out.write("					<th>총 배송비</th>\r\n");
      out.write("					<th>3000</th>\r\n");
      out.write("					<th>결제예정금액</th>\r\n");
      out.write("					<th class=\"totalPrice2\">");
      out.print( totalPrice+=3000 );
      out.write("</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</thead>\r\n");
      out.write("		</table>\r\n");
      out.write("		<div align=\"center\">\r\n");
      out.write("			<button type=\"button\" id=\"submit\">주문하기</button>	\r\n");
      ...
      out.write("				$.ajax({\r\n");
      out.write("					url : \"cartQuanPlusMinus.my\",\r\n");
      out.write("					data : {\r\n");
      out.write("						productName : $(this).parent().parent().prev().prev().text(),\r\n");
      out.write("						plusMinus : \"+\",\r\n");
      out.write("						quantity : $(this).prev('input').val()\r\n");
      out.write("					},\r\n");
      out.write("					context : this,\r\n");
      out.write("					type : \"post\",\r\n");
      out.write("					success : function(result){\r\n");
      out.write("						$(this).prev('input').val(result);\r\n");
      out.write("						var pPrice = Number($(this).parent().parent().prev().text());\r\n");
      out.write("						$(this).parent().parent().next().text(pPrice * Number(result));\r\n");
      out.write("						$('.totalPrice1').text(Number($('.totalPrice1').text())+pPrice);\r\n");
      out.write("						$('.totalPrice2').text(Number($('.totalPrice2').text())+pPrice);\r\n");
      out.write("					},\r\n");
      out.write("					error : function(){\r\n");
      out.write("						alert(\"수량조절실패\");\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("			})\r\n");
      out.write("			\r\n");
      out.write("			$(\".minusBtn\").click(function(){\r\n");
      out.write("				if($(this).next('input').val() == 0){\r\n");
      out.write("					alert(\"0개 이하로는 설정 불가합니다.\");\r\n");
      out.write("				} else {\r\n");
      out.write("					$.ajax({\r\n");
      out.write("						url : \"cartQuanPlusMinus.my\",\r\n");
      out.write("						data : {\r\n");
      out.write("							productName : $(this).parent().parent().prev().prev().text(),\r\n");
      out.write("							plusMinus : \"-\",\r\n");
      out.write("							quantity : $(this).next('input').val()\r\n");
      out.write("						},\r\n");
      out.write("						context : this,\r\n");
      out.write("						type : \"post\",\r\n");
      out.write("						success : function(result){\r\n");
      out.write("							$(this).next('input').val(result);\r\n");
      out.write("							var pPrice = Number($(this).parent().parent().prev().text());\r\n");
      out.write("							$(this).parent().parent().next().text(pPrice * Number(result));\r\n");
      out.write("							$('.totalPrice1').text(Number($('.totalPrice1').text())-pPrice);\r\n");
      out.write("							$('.totalPrice2').text(Number($('.totalPrice2').text())-pPrice);\r\n");
      ...
      out.write("			})\r\n");
      out.write("			\r\n");
      out.write("			$(\".chkBox\").change(function(){\r\n");
      out.write("				if(this.checked) {\r\n");
      out.write("					var totalPrice1 = Number($('.totalPrice1').text());\r\n");
      out.write("					var totalPrice2 = Number($('.totalPrice2').text());\r\n");
      out.write("					var price = Number($(this).parent().next().next().next().text());\r\n");
      out.write("					var quan = Number($(this).parent().next().next().next().next().children().children().next().val());\r\n");
      out.write("\r\n");
      out.write("					$('.totalPrice1').text(totalPrice1 + price*quan);\r\n");
      out.write("					$('.totalPrice2').text(totalPrice2 + price*quan);\r\n");
      out.write("					\r\n");
      out.write("				} else {\r\n");
      out.write("					var totalPrice1 = Number($('.totalPrice1').text());\r\n");
      out.write("					var totalPrice2 = Number($('.totalPrice2').text());\r\n");
      ...
      out.write("			})\r\n");
      out.write("			\r\n");
      out.write("			$('#chkBoxAll').change(function(){\r\n");
      out.write("				if(this.checked) {\r\n");
      out.write("					$('.chkBox').each(function(index, value) {\r\n");
      out.write("						value.checked = true;\r\n");
      out.write("						var totalPrice = 0;\r\n");
      out.write("					$('.price').each(function(index, value){\r\n");
      out.write("						totalPrice += Number(value.innerHTML);\r\n");
      out.write("					})\r\n");
      out.write("\r\n");
      out.write("					$('.totalPrice1').text(totalPrice);\r\n");
      out.write("					$('.totalPrice2').text(totalPrice + 3000);\r\n");
      out.write("				})\r\n");
      out.write("				} else {\r\n");
      out.write("					$('.chkBox').each(function(index, value) {\r\n");
      out.write("						value.checked = false;\r\n");
      out.write("						$('.totalPrice1').text(0);\r\n");
      out.write("						$('.totalPrice2').text(3000);\r\n");
      out.write("						return;\r\n");
      out.write("					})\r\n");
      out.write("				}\r\n");
      out.write("			})\r\n");
      ...
      out.write("				var pNames = \"\";\r\n");
      out.write("\r\n");
      out.write("				$('.chkBox').each(function() {\r\n");
      out.write("					if(this.checked) {\r\n");
      out.write("						pNames += ($(this).parent().next().next().text()) + \",\";\r\n");
      out.write("					}\r\n");
      out.write("				})\r\n");
      out.write("				\r\n");
      out.write("				location.href = \"");
      out.print( contextPath );
      out.write("\" + \"/cartOrder.my?pNames=\" + pNames;\r\n");
      out.write("			})\r\n");
      out.write("		</script>\r\n");
      out.write("	</div>\r\n");
      out.write("	<!-- footer 시작 -->\r\n");
