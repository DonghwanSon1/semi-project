...
/**
 * Servlet implementation class CenterDetailController
 */
@WebServlet("/detail.ce")
public class CenterDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CenterDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/center/centerDetailView.jsp").forward(request, response);
