...
/**
 * Servlet implementation class CenterInfoListController
 */
@WebServlet("/infoList.ce")
public class CenterInfoListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CenterInfoListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new CenterService().selectInfoListCount();
		...
		// 이용안내 리스트  => 가져올 행의 갯수 : 최소 0개~ 여러개 따라서 arrayList로 담는다.
		ArrayList<CenterInfo> list = new CenterService().selectCenterInfoList(pi);
		...
		// 화면 띄우기
		request.getRequestDispatcher("/views/center/centerInfoListView.jsp").forward(request, response);
