...
/**
 * Servlet implementation class CenterInsertController
 */
@WebServlet("/insert.ce")
public class CenterInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CenterInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String writer = request.getParameter("memberNo");
				...
				if(result > 0 ) {
					// 성공시
					request.getSession().setAttribute("alertMsg", "1:1 문의 등록되었습니다.");
					response.sendRedirect(request.getContextPath() + "/list.ce?cpage=1");
				} else {
					request.setAttribute("errorMsg", "1:1 문의 등록 실패했습니다.");
