	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			if(multiRequest.getOriginalFileName("reUpfile") != null) {
				...
				et.setOriginName(multiRequest.getOriginalFileName("reUpfile"));
				et.setChangeName(multiRequest.getFilesystemName("reUpfile"));
				...
				if(multiRequest.getParameter("originFileNo") !=null) {
					...
					et.setFileNo(Integer.parseInt(multiRequest.getParameter("originFileNo")));
				...
				int result = new EventService().updateEvent(e, et);
