				...
				<tr>
					<td colspan="2">
                        <div class="form-group col-md-12">
                                  <textarea id="contents" name="content" cols="40" placeholder="공지 내용을 입력해주세요." rows="20" class="form-control" style="resize: none;" required></textarea>
                        </div>
					</td>
				</tr>
			</table>
