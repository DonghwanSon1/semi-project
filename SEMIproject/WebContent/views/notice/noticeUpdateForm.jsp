	...
	<%@ include file="../common/header.jsp" %>
        ...
        <form id="update-form" action="<%=contextPath %>/update.no" method="post">
            ...
            <table class="table" align="center" border="2">
                <tr>
                    <th width="80">제목</th>
                    <td colspan="3"><input size="70" class="form-control" type="text" name="title" placeholder="<%= n.getNoticeTitle() %>" required></td>
                </tr>
                <tr>
	                <th>작성자</th>
                ...
                <tr>
                    <th>내용</th>
                    <td colspan="3">
                        <textarea name="content" class="form-control" cols="80" rows="11" placeholder="<%=n.getNoticeContent() %>" style="resize: none;" required ></textarea>
                    </td>
                </tr>
            </table>
