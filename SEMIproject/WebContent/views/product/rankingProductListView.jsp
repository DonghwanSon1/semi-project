...
<div class="outer">
	...
	<!-- "상품" 타이틀 이미지 영역 -->
		<img src="<%= contextPath %>/resources/img/product/ranking_product_thumbnailtitle.png">
	</div>


	<!-- "상품" 타이틀 텍스트 영역 -->
		<div class="page-description-area">
			<h2 class="page-title">랭킹상품</h2>
			<span class="page-title-sub">닭치고 이거닭에서만 만날수 있는 최고의 상품들!!</span>
		</div>
		<!-- =================================  상품 리스트 나열  ========================================
			======================================================================================= -->
		<!-- 상품리스트 세부 영역-->
